...
const StatDebug = ({ app = App3D, renderer, ...props }) => {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            app.removeEvent(AppEvent.BEFORE_RENDER, beforeRenderUpdate)
            app.removeEvent(AppEvent.AFTER_RENDER, afterRenderUpdate)
        }
    }, [])
    ...
    const init = () => {
        ...
        app.addEvent(AppEvent.BEFORE_RENDER, beforeRenderUpdate);
        app.addEvent(AppEvent.AFTER_RENDER, afterRenderUpdate);
    }
