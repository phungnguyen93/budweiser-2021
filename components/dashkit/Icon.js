...
/**
 * @param  {Object} props
 * @param  {('admin'|'app-store-filled'|'arrow-collapse'|'arrow-expand'|'arrow-left-thin'|'arrow-left'|'arrow-right-tail-thin'|'arrow-right-thin'|'arrow-right'|'bell'|'book-open'|'close'|'dashboard'|'delete'|'done'|'file'|'hamburger'|'home'|'link'|'mail'|'play-circle'|'search'|'setting'|'upload'|'user'|'share')} props.name
 ...
 */
const DashkitIcon = function ({ name, style, fill, color, size, width, height, ...rest }) {
